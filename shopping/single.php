...
?>
<!-- Your HTML code using $product goes here -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="images p-3">
                                <div class="text-center p-4"> <img id="main-image" src="../images/<?php echo $product->image; ?>" width="250" />
 </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="product p-4">
                                ...
                                <form action="" method="post" id="form-data">
                                    <div class="">
                                    <input type="hidden" name="pro_id" value="<?php echo $product->id;?>" class="form_control">

                                    </div>
                                    <div class="">
                                        <input type="hidden" name="pro_name" value="<?php echo $product->name;?>" class="form_control">
                                    </div>

                                    <div class="">
                                        <input type="hidden" name="pro_image" value="<?php echo $product->image;?>" class="form_control">
                                    </div>
                                    ...
                                    <div class="">
                                        <input type="hidden" name="pro_amount" value="1" class="form_control">
                                    </div>

                                    <div class="">
                                        <input type="hidden"  name="pro_file" value="<?php echo $product->file?>"  class="form_control">
                                    </div>
                    <?php if(isset($_SESSION['id'])): ?>
                                    <div class="">
                                        <input type="hidden" name="user_id" value="<?php echo $_SESSION['id'] ;?>" class="form_control">
                                    </div>
                    <?php endif;?>
